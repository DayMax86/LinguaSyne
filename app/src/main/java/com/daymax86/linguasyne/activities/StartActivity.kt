package com.daymax86.linguasyne.activities
...
import com.daymax86.linguasyne.screens.*
import com.daymax86.linguasyne.ui.elements.*
import com.daymax86.linguasyne.viewmodels.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val sendIntent: Intent = Intent().apply {
                ...
                putExtra(
                    Intent.EXTRA_TEXT,
                    "http://play.google.com/store/apps/details?id=com.daymax86.linguasyne"
                )
                type = "text/plain"
            }
